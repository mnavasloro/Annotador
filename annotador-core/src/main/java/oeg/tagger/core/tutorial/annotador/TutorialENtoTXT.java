 ...
 * @author mnavas
 */
public class TutorialENtoTXT {

    public static void main(String[] args) throws IOException {
        PrintWriter out;

//    String rules = "../annotador-core/src/main/resources/rules/rulesEScomposite.txt";
        String rules = "../annotador-core/src/main/resources/rules/rulesEN.txt";
...
//        File f = new File("../annotador-core/src/main/resources/rules/TESTEN.txt");
//        String s = FileUtils.readFileToString(f, "UTF-8");
String txt = "Two weekdays and a half" ;        
