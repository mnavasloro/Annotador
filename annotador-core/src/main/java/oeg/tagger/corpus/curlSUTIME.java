...
public class curlSUTIME {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String foutput = "../annotador-core/src/main/resources/rules/sutime_test_output/";
...
public static String callCURL(String inp, String file){
             Runtime runtime = Runtime.getRuntime();
             String orTxt = inp;
//             String txt = inp;
             int offset = 0;
...
//    txt = txt.replaceAll("ñ", "\\%C3\\%B1");
    ...
    String mandar = "curl -X POST 'https://corenlp.run/?properties=%7B%22annotators%22%3A%20%22tokenize%2Cssplit%2Cpos%2Cner%2Cregexner%2Copenie%22%2C%20%22date%22%3A%20%222019-12-20%22%7D&pipelineLanguage=es' -d '" + txt + "' > '" + file + "'";
