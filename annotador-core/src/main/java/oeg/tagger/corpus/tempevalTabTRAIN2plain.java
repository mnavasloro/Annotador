 ...
 * @author mnavas
 */
public class tempevalTabTRAIN2plain {
    ...
    public static void main(String[] args) {
        ...
        String foutput = "C:\\Users\\mnavas\\CODE\\OLD_CODE\\data\\datasets\\timeEval\\tempeval2\\TRAIN\\tempeval2plain\\";
...
//        try (BufferedReader br = new BufferedReader( new InputStreamReader(new FileInputStream("C:\\Users\\mnavas\\CODE\\OLD_CODE\\data\\datasets\\timeEval\\tempeval2\\tempeval2-test\\spanish\\relations\\base-segmentation.tab"), "UTF8"))) {
        try (BufferedReader br = new BufferedReader( new InputStreamReader(new FileInputStream("C:\\Users\\mnavas\\CODE\\OLD_CODE\\data\\datasets\\timeEval\\tempeval2\\tempeval-training-2\\spanish\\data\\base-segmentation.tab"), "UTF8"))) {
            ...
            Logger.getLogger(tempevalTabTRAIN2plain.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
